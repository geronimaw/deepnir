...
if __name__ == "__main__":
    ...
    output_csv = os.path.join(out_path, "outputs", "svm_performance")
    os.makedirs(output_csv, exist_ok=True)
    out_models_path = os.path.join(out_path, "outputs", "svm_trained")
    ...
    for y_col in y_train_all[list(y_train_all.keys())[0]].keys():
        ...
        results = train_svm_regr(X_train_combined, X_val_combined, y_train_combined, y_val_combined, 
        ...
        if y_col == "DM" or y_col == "SS": 
            ...
            results = train_svm_classif(X_train_combined.drop(columns=["dataset_label"]), X_val_combined.drop(columns=["dataset_label"]),
